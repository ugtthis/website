export const products = {
  ...
  "comma-device-screen": {
    ...
    description: `
      ...
      <strong>comma 3/3X - screen only</strong>
      <ul>
  ...
  "comma-four-trade-in": {
    ...
    notes: `
      <NoteCard title="Note">
        If you are already using a car harness, you only need to purchase this product. Do not return your car harness or other accessories. comma two, comma three, comma 3X, and comma four use the same harness.
      </NoteCard>
    `.trim(),
    description: `
      <strong>Description</strong>
