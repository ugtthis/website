...
<section id="vehicles" class="light">
  <div class="container">
    <Grid columnGap="4rem" rowGap="2rem" templateColumns="1.25fr 1fr">
      <div class="title">
        openpilot supports 275+ vehicles
      </div>
                  ...
                  <div class="device-promotion-card">
                    <div class="product-wrapper">
                      ...
                      <hgroup>
                        ...
                        <div>${THREEX_PRICE}</div>
                        {#if car_info.harness_connector !== "" }
                          <strong>car harness: { car_info.harness_connector }</strong>
                          <div>+${CAR_HARNESS_PRICE}</div>
                        {/if}
                      </hgroup>
                    </div>
                    <LinkButton
                      href={`/shop/comma-3x?make=${make}&model=${car_info.model} ${car_info.years ? car_info.years : ''}`}
                      style="primary"
                      fullWidth
                      thin
                    >
