  ...
  <div class="container">
    <Grid templateColumns="0.5fr 1.25fr">
      ...
      <div class="fine-print-copy">
          ...
          <p>
            Save offer within PayPal account prior to purchase here: <a href="https://www.paypal.com/us/digital-wallet/ways-to-pay/buy-now-pay-later" target="_blank" class="highlight">https://www.paypal.com/us/digital-wallet/ways-to-pay/buy-now-pay-later</a>. Expires 12/8/25. 20% on up to max $1,250 spend per transaction (max 25K points or $250). 1.5B points available in total for this promo. See <a href="https://www.paypal.com/promoterms" target="_blank" class="highlight">paypal.com/promoterms</a>. Points can be redeemed for cash and more. PayPal may at any time and in its sole discretion, without prior notice, terminate, cancel, suspend or modify this offer or these terms. Terms and exclusions apply. See <a href="https://www.paypal.com/rewardsterms" target="_blank" class="highlight">paypal.com/rewardsterms</a>.
          </p>
          <p>
