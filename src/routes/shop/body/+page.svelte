    ...
    <div class="features">
      ...
      <div class="image-grid">
        <Grid columns={3} alignItems="center">
          <img src={CommaBodyScreenImage} loading="lazy" alt="comma body screen" />
          <img src={CommaBodyBaseImage} loading="lazy" alt="comma body base" />
          <img src={CommaBodyInternalsImage} loading="lazy" alt="comma body internals" />
        </Grid>
      </div>
      <div class="item">
